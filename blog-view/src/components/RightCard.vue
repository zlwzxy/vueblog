<template>
  <div class="card">
    ...
    <p style="margin-top: 0px;">Welcome to LaoZhaoTou's Blog</p>
    <div>
...
export default {
  ...
  methods: {
    ...
    getRunTime() {
      var birthDay = this.NewDate("2021-08-20");
      var today = new Date();
      ...
      document.getElementById("showsectime").innerHTML = "This blog has running:" + daysold + "天";
