<template>
  ...
  <div class="footer">
    ...
    <el-row :gutter="24" style="padding-top: 30px">
      <el-col :sm="8">
        ...
        <el-row :gutter="24" class="footer-content">
          <el-col :sm="10" :offset="4">
            QQ：1033865504<br>
            邮箱：1033865504@qq.com
          </el-col>
          <el-col :sm="10">
           <!-- <el-image :src="src" style="width: 80px; height: 80px"></el-image> 可以放一张图片-->
          </el-col>
        </el-row>
      </el-col>
      ...
      <el-col :sm="8">
        <el-row :gutter="24" class="footer-title">
          <el-col :span="24" style="font-size: 20px">签名</el-col>
        </el-row>
        <el-row :gutter="24" class="footer-content">
          <el-col :span="24" style="font-size: 20px; color: #2487dd;">
    ...
    <el-row :gutter="24" style="height: 30px;margin-top: 25px;font-size: 12px">
      <el-col :span="24">
		  Copyright&nbsp;&copy;&nbsp;2021-2022&nbsp;LaoZhaoTou&nbsp;Blog.
		  <a href="https://beian.miit.gov.cn/" style="font-size: 12px;color: #2F80ED;"> 陇ICP备&nbsp;&nbsp;2021001093号-1</a>
